...
export const metadata: Metadata = {
  title: 'highlight Dashboard - mayhm.co',
  description:
    'Explore the categories of mayhm.co in this comprehensive dashboard. View details about each highlight including assets and performance.',
  keywords: [
    'mayhm.co',
    'highlight dashboard',
    'assets',
...
async function getData(page = 1, row = 10, search = '') {
  ...
  }/api/highlight?page=${page}&row=${row}${
