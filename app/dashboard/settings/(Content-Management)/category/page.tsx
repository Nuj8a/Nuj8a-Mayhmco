...
export const metadata: Metadata = {
  title: 'Category Dashboard - mayhm.co',
  description:
    'Explore the categories of mayhm.co in this comprehensive dashboard. View details about each category including assets and performance.',
  keywords: [
    'mayhm.co',
    'category dashboard',
    'assets',
...
async function getData(page = 1, row = 10, search = '') {
  ...
  }/api/category?page=${page}&row=${row}${
